        ...
        <div className='flex items-center gap-2 br bg-slate-200 rounded-tl-3xl rounded-bl-3xl rounded-tr-[60px] rounded-br-[160px]'>
            <div className='flex flex-col items-center gap-[20px] '>
                <div className=' justify-between items-center text-1xl'>
                    <h1 className='text-1xl pl-10 pr-10'>Chaque porte ouverte est une opportinuté, <span className=' text-[#FF8686]'>voici celle qui mène à votre propriété de reve</span></h1>
                </div>
                <div className='flex items-center gap-[10px]'>
                    ...
                    <button className='border border-black rounded-full px-2 py-2'>Publier une propriété</button>
                </div>
            </div>
